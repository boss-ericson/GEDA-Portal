...
export default function LandingPage({ schools, onLogin, onRegisterSchool }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#0a0f1c] text-slate-300 font-sans selection:bg-emerald-500/30 selection:text-emerald-200 overflow-x-hidden">
      {/* Subtle Background Glows */}
      <div className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-lg h-[500px] bg-emerald-600/20 blur-[120px] rounded-full pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-16 lg:gap-8 items-center">
            ...
            <motion.div 
              ...
              id="login-portal"
            >
              <div className="bg-[#0f172a]/80 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl p-6 sm:p-8 relative overflow-hidden">
                <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-emerald-500 via-cyan-500 to-blue-500"></div>
                <div className="absolute top-0 right-8 transform -translate-y-1/2 bg-[#0a0f1c] text-emerald-400 font-mono font-semibold text-[10px] uppercase px-3 py-1 rounded-full border border-emerald-500/30 shadow-[0_0_10px_rgba(16,185,129,0.2)]">
                  SCHOOL LOGIN PORTAL
                </div>
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-5">
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full bg-[#0a0f1c] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 text-sm transition-all placeholder:text-slate-600"
                            required
                          />
                        </div>
                      </div>
                      <div>
                        ...
                        {loginEmail.includes('@geda.edu.gh') && (
                          <span className="text-[11px] text-emerald-400/80 block mt-2">Demo password for default schools: <b className="text-emerald-400">password123</b></span>
                        )}
                        {loginEmail.includes('superadmin@ges.gov.gh') && (
                          <span className="text-[11px] text-emerald-400/80 block mt-2">Demo password for super admin: <b className="text-emerald-400">admin123</b></span>
                        )}
                      </div>
                    </motion.div>
                  ) : (
                        ...
                        <button
                          ...
                          className={\`py-2 px-2 text-xs font-semibold rounded-xl border transition-all flex flex-col items-center justify-center gap-1.5 cursor-pointer \${
                            selectedRole === role
                              ...
                              : 'bg-[#0a0f1c] border-white/5 text-slate-500 hover:bg-white/5 hover:text-slate-300'
                          }\`}
                        >
            ...
            <form onSubmit={handleRegister} className="grid sm:grid-cols-2 gap-6">
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  className="w-full bg-[#0a0f1c] border border-white/10 rounded-xl px-4 py-3.5 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 text-sm transition-all placeholder:text-slate-600"
                  required
                />
              </div>
              <div>
      ...
      {/* Footer */}
      <footer className="bg-[#04060d] text-slate-500 py-12 border-t border-white/5">
